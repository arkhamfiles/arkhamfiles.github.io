...
""" Table of Contents auto-generator for HTML code
I don't sure that this will work for common html, but work for our RR.html

How to use
* run script. Then, ToC is generated by text file
* copy & paste txt in original html file
That's all. You may call --help method for argument.
"""
